...
# ``mlops_dry_run/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops_dry_run-experiment_challenger",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.mlops_dry_run.mlops_dry_run-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.mlops_dry_run.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.mlops_dry_run.trip_dropoff_features",
