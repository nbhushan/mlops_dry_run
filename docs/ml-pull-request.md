...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops_dry_run-run-tests.yml) 
...
Links:
* [Staging model in UC](https://dbc-8f214e2f-9ce9.cloud.databricks.com/explore/data/models/staging/mlops_dry_run/mlops_dry_run-model)
* [Prod model in UC](https://dbc-8f214e2f-9ce9.cloud.databricks.com/explore/data/models/prod/mlops_dry_run/mlops_dry_run-model)
. 
